...
class MyBagViewController: UIViewController {
    ...
    func updateControl() {
        ...
        let film1: AnyObject? = userSetting?.objectForKey("film1")
        if film1 != nil {
            var text1 = film1!.objectAtIndex(0) as! NSString
            filter1.text = text1 as String
        ...
        let film2: AnyObject? = userSetting?.objectForKey("film2")
        if film2 != nil {
            var text1 = film2!.objectAtIndex(0) as! NSString
            filter2.text = text1 as String
        ...
        let film3: AnyObject? = userSetting?.objectForKey("film3")
        if film3 != nil {
            var text1 = film3!.objectAtIndex(0) as! NSString
            filter3.text = text1 as String
        ...
        let film4: AnyObject? = userSetting?.objectForKey("film4")
        if film4 != nil {
            var text1 = film4!.objectAtIndex(0) as! NSString
            filter4.text = text1 as String
        ...
        if film5 != nil {
            var text1 = film5!.objectAtIndex(0) as! NSString
            filter5.text = text1 as String
        ...
        if film6 != nil {
            var text1 = film6!.objectAtIndex(0) as! NSString
            filter6.text = text1 as String
        ...
        if film7 != nil {
            var text1 = film7!.objectAtIndex(0) as! NSString
            filter7.text = text1 as String
        ...
        if film8 != nil {
            var text1 = film8!.objectAtIndex(0) as! NSString
            filter8.text = text1 as String
    ...
    func choicesDialog(filmRow:AnyObject?){
        ...
        chooseDialog.addAction(UIAlertAction(title: "Use", style: .Default, handler: { (action: UIAlertAction!) in
            ...
            if filmRow != nil {
                var text2 = filmRow!.objectAtIndex(1) as! Int
              save.variable.myNum = text2
